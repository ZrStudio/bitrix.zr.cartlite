<?
$MESS["ZR_CL_NEW_ORDER_NAME"] = "Новый заказ";
$MESS["ZR_CL_NEW_ORDER_DESC"] = "#ORDER_ID# - код заказа
...
#SITE_NAME#
";
$MESS["ZR_CL_NEW_ORDER_RECURRING_NAME"] = "Новый заказ на продление подписки";
$MESS["ZR_CL_NEW_ORDER_RECURRING_DESC"] = "#ORDER_ID# - код заказа
#ORDER_ACCOUNT_NUMBER_ENCODE# - код заказа(для ссылок)
#ORDER_REAL_ID# - реальный ID заказа
#ORDER_DATE# - дата заказа
#ORDER_USER# - заказчик
...
#ORDER_LIST# - состав заказа
#SALE_EMAIL# - E-Mail отдела продаж";
$MESS["ZR_CL_NEW_ORDER_RECURRING_SUBJECT"] = "#SITE_NAME#: Новый заказ N#ORDER_ID# на продление подписки";
$MESS["ZR_CL_NEW_ORDER_RECURRING_MESSAGE"] = "Информационное сообщение сайта #SITE_NAME#
------------------------------------------
...
$MESS["ZR_CL_NEW_ORDER_HTML_TITLE"] = "Вами оформлен заказ в магазине #SITE_NAME#";
$MESS["ZR_CL_NEW_ORDER_HTML_SUB_TITLE"] = "Уважаемый #ORDER_USER#,";
$MESS["ZR_CL_NEW_ORDER_HTML_TEXT"] = "Ваш заказ номер #ORDER_ID# от #ORDER_DATE# принят.
